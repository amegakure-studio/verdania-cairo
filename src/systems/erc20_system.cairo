...
mod ERC20 {
    ...
    impl ERC20Impl of IERC20::IERC20<ContractState> {
        fn init(ref self: ContractState, name: felt252, symbol: felt252, initial_supply: u64) {
            let recipient = get_caller_address();
            self.initializer(name, symbol, recipient);
            self._mint(recipient, initial_supply);
        }

        fn mint(ref self: ContractState, recipient: ContractAddress, amount: u64) {
        ...
        fn balance_of(self: @ContractState, account: ContractAddress) -> u64 {
        ...
        fn transfer(ref self: ContractState, recipient: ContractAddress, amount: u64) -> bool {
        ...
        fn approve(ref self: ContractState, spender: ContractAddress, amount: u64) -> bool {
    ...
    impl ERC20CamelOnlyImpl of IERC20::IERC20CamelOnly<ContractState> {
        fn totalSupply(self: @ContractState) -> u64 {
            ERC20Impl::total_supply(self)
        }

        fn balanceOf(self: @ContractState, account: ContractAddress) -> u64 {
    ...
    fn increase_allowance(
        ref self: ContractState, spender: ContractAddress, added_value: u64
    ) -> bool {
    ...
    fn increaseAllowance(
        ref self: ContractState, spender: ContractAddress, addedValue: u64
    ) -> bool {
    ...
    fn decrease_allowance(
        ref self: ContractState, spender: ContractAddress, subtracted_value: u64
    ) -> bool {
    ...
    fn decreaseAllowance(
        ref self: ContractState, spender: ContractAddress, subtractedValue: u64
    ) -> bool {
    ...
    impl WorldInteractionsImpl of WorldInteractionsTrait {
        ...
        fn update_total_supply(ref self: ContractState, subtract: u64, add: u64) {
        ...
        fn update_balance(
            ref self: ContractState, account: ContractAddress, subtract: u64, add: u64
        ) {
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn _mint(ref self: ContractState, recipient: ContractAddress, amount: u64) {
        ...
        fn _burn(ref self: ContractState, account: ContractAddress, amount: u64) {
        ...
        fn _approve(
            ref self: ContractState, owner: ContractAddress, spender: ContractAddress, amount: u64
        ) {
            self.set_allowance(ERC20Allowance { id: ERC20_CONTRACT_ID, owner, spender, amount });
        }
